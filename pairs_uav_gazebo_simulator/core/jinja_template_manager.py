...
from pairs_uav_gazebo_simulator.utils.component_wrapper import ComponentWrapper
from pairs_uav_gazebo_simulator.utils.template_wrapper import TemplateWrapper
...
class JinjaTemplateManager():
    ...
    def render_sdf(self, spawner_args):
        ...
        try:
            ...
            fd, filepath = tempfile.mkstemp(prefix='pairs_drone_spawner_' +
