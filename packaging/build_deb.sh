...
# dependency .debs from /prebuilt, then builds pairs_uav_gazebo_simulator and copies the .deb to /output.
#   PAIRS deps (build order, supplied from /prebuilt): pairs_msgs pairs_gazebo_common_resources pairs_uav_px4_api
set -eo pipefail
ROS_DISTRO_NAME="jazzy"; OS_NAME="ubuntu"; OS_VERSION="noble"
source "/opt/ros/${ROS_DISTRO_NAME}/setup.bash"
set -u

LOCAL_RULES="/src/pairs_uav_gazebo_simulator/packaging/rosdep/pairs.yaml"
...
build_one /src/pairs_uav_gazebo_simulator
