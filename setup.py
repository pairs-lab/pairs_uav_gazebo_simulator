...
package_name = 'pairs_uav_gazebo_simulator'
...
setup(
    name='pairs-uav-gazebo-simulator',
    version='2.0.0',
    ...
    description='The Metapackage for PAIRS UAV Gazebo simulation pipeline.',
    license='BSD 3-Clause',
    tests_require=['pytest'],
    entry_points={
        'console_scripts': [
            'pairs_drone_spawner = pairs_uav_gazebo_simulator.pairs_drone_spawner:main',
        ],
    },
)
