"""Launch gzsim + ros_gz_bridge + pairs_spawner in a component container."""
...
def generate_launch_description():
    ...
    pkg_pairs_common_gazebo_resources = get_package_share_directory('pairs_gazebo_common_resources')
    pkg_pairs_uav_gazebo_simulator = get_package_share_directory('pairs_uav_gazebo_simulator')
    ...
    declare_world_file_arg = DeclareLaunchArgument(
        ...
        default_value = PathJoinSubstitution([
                pkg_pairs_common_gazebo_resources, 'worlds', 'grass_plane.sdf'
            ]),
    ...
    declare_gz_sim_server_config_path_arg =  DeclareLaunchArgument(
        ...
        default_value=PathJoinSubstitution([
            pkg_pairs_uav_gazebo_simulator, 'config/gazebo_server.config'
        ]),
    ...
    drone_spawner = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            PathJoinSubstitution([
                pkg_pairs_uav_gazebo_simulator, 'launch', 'pairs_drone_spawner.launch.py'
            ])
        ),
        launch_arguments={
