...
#include <pairs_uav_gazebo_testing/test_generic.h>

class Tester : public pairs_uav_gazebo_testing::TestGeneric {
...
bool Tester::test() {
  ...
  std::shared_ptr<pairs_uav_gazebo_testing::UAVHandler> uh;
